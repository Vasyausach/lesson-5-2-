let startBtn = document.getElementById('start'), //начать расчет
    ...
    monthSavingsValue = document.getElementsByClassName('monthsavings-value'), //накопления за один месяц
    yearSavingsValue = document.getElementsByClassName('yearsavings-value'), //накопления за один год
